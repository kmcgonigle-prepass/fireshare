...
> implements ViewModel<Props>
{
  ...
  constructor(
    ...props: Props extends Record<string, never> ? [] : [props: Props]
  ) {
 ...
 * ```tsx
 * 
class ExampleViewModel extends BaseViewModel<{ someProp: string }> {
...
export function useViewModelConstructor<
  R extends ViewModel<Record<string, never>>,
